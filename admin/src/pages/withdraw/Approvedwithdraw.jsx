    ...
    try {
      ...
      const response = await axios.get(`${API_BASE_URL}/api/admin/withdrawals`, {
        ...
        params: {
          page: currentPage,
          limit: itemsPerPage,
          status: 'completed', // Only fetch completed withdrawals
        ...
        >
          <div className="w-full mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
              <div>
                <h1 className="text-2xl font-bold text-gray-800">Completed Withdrawals</h1>
                <p className="text-sm text-gray-600 mt-1">View all successfully processed withdrawal transactions</p>
              </div>
            ...
            <div className="mb-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-2">
              <p className="text-gray-600">
                Showing {withdrawals.length} of {stats.total} completed withdrawals
              </p>
                        ...
                        <tr>
                          <td colSpan="7" className="px-6 py-12 text-center">
                            <div className="flex flex-col items-center justify-center text-gray-400">
                              ...
                              <p className="text-lg font-medium text-gray-500">No completed withdrawals found</p>
        ...
        <div className="fixed inset-0 bg-[rgba(0,0,0,0.4)] bg-opacity-50 flex items-center justify-center z-[1000] backdrop-blur-md p-4">
          <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
              <h3 className="text-lg font-medium text-gray-900">Completed Withdrawal Details</h3>
