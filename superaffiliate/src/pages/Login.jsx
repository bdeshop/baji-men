...
const Login = () => {
  ...
  return (
    <div className="min-h-screen font-poppins flex items-center justify-center bg-gradient-to-br from-green-900 to-emerald-800 p-4">
      <Toaster position="top-center" />
      
      <div className="bg-gray-800/90 backdrop-blur-md p-8 rounded-xl shadow-xl w-full max-w-md relative overflow-hidden border border-emerald-700">
        ...
        <div className="mt-6 text-center">
          <p className="text-xs text-gray-400 mb-4">
            ...
            <Link 
              to="/register" 
              className="text-emerald-400 hover:text-emerald-300 font-medium underline transition-colors duration-200"
            >
              Register here
            </Link>
          </p>
          ...
          <div className="bg-amber-500/10 border border-amber-500/30 rounded-[5px] p-3 mt-4">
            <h4 className="text-amber-400 font-medium mb-1 text-sm">Account Approval Required</h4>
            <p className="text-amber-300 text-xs">
              After registration, please wait for admin approval. You will be able to login once your account is activated.
            </p>
          </div>
